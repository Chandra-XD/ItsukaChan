 ...
 */
const {initAuthCreds, BufferJSON, WAProto} = (await import('@whiskeysockets/baileys'))
              ...
              (dict, id) => {
                ...
                if (value) {
                  if (type === 'app-state-sync-key') {
                    value = WAProto.AppStateSyncKeyData.fromObject(value);
                  }
...
function loadMessage(jid, id = null) {
  ...
  if (jid && !id) {
    id = jid;
    /** @type {(m: import('@whiskeysockets/baileys').WAProto.WebMessageInfo) => Boolean} */
