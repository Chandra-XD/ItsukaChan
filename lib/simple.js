...
export function makeWASocket(connectionOptions, options = {}) {
    ...
    let sock = Object.defineProperties(conn, {
        ...
        sendFile: {
             ...
             * @param {import('@whiskeysockets/baileys').WAProto.WebMessageInfo} quoted
             * @param {Boolean} ptt
            ...
            async value(jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) {
                ...
                /**
                 * @type {import('@whiskeysockets/baileys').WAProto.WebMessageInfo}
                 */
                let m
                try {
...
END:VCARD
      ...
      value(buffer, ukur1, ukur2) {
        ...
        cMod: {
             ...
             * cMod
             * @param {String} jid 
             * @param {import('@whiskeysockets/baileys').WAProto.WebMessageInfo} message 
             * @param {String} text 
             * @param {String} sender 
             * @param {*} options 
             * @returns 
        ...
        copyNForward: {
            ...
            async value(jid, message, forwardingScore = true, options = {}) {
                ...
                if (options.readViewOnce && message.message.viewOnceMessage?.message) {
                    ...
                    message.message = WAProto.Message.fromObject(
        ...
        loadMessage: {
             ...
             * @returns {import('@whiskeysockets/baileys').WAProto.WebMessageInfo}
             */
            value(messageID) {
        ...
        processMessageStubType: {
             ...
             * @param {import('@whiskeysockets/baileys').WAProto.WebMessageInfo} m 
             */
            async value(m) {
        ...
        pushMessage: {
            ...
            async value(m) {
                ...
                for (const message of m) {
                    try {
                        // if (!(message instanceof WAProto.WebMessageInfo)) continue // https://github.com/whiskeysockets/Baileys/pull/696/commits/6a2cb5a4139d8eb0a75c4c4ea7ed52adc0aec20f
                        if (!message) continue
                        ...
                        if (message.message?.[mtype]?.contextInfo?.quotedMessage) {
                            /**
                             * @type {import('@whiskeysockets/baileys').WAProto.IContextInfo}
                             */
                            let context = message.message[mtype].contextInfo
                            let participant = conn.decodeJid(context.participant)
                            const remoteJid = conn.decodeJid(context.remoteJid || participant)
                            /**
                             * @type {import('@whiskeysockets/baileys').WAProto.IMessage}
                             * 
                             */
        ...
        profilePictureUrl: {
        async value(jid, type = 'preview', opts = {}) {
		...
		return opts.raw ? child : child?.attrs?.url
	}
	},
