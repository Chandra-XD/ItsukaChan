...
<details>
 <summary>Baca Ini Kalo Mau Pasang</summary>

LANGKAH PERTAMA KEK BIASANYA INSTALL MODULE NYA
...
node connect
```
MASUKIN NOMOR LU DI CONSOLE NYA, NTAH DI PANEL ATAUPUN ITU
NOMOR BERAWALAN PAKE 62 ATAU KODE NEGARA JANGAN 08 LAH INTINYA
NANTI MUNCUL NOTIFIKASI DARI WA, TRS MASUKIN KODE. INI CONTOH YA
```bash
MMEX-KTL5
```
KALO UDH KONEK TINGGAL KE CONSOLE LAGI UBAH JADI
```bash
node .
```
INTINYA KALO UDH AMBIL SESSION YAUDAH UDH KONEK ITU JANGAN LUPA RESTART SEBELUM GANTI COMMAND NYA

PAKE INI KALO MAU SELF BOT 
```bash
node . --self
```
DAH ITU AJA
